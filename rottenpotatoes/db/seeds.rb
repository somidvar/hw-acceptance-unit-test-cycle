...
movies = [{:title => 'Aladdin', :rating => 'G', :release_date => '25-Nov-1992', :director => 'Guy Ritchie'},
    	  ...
    	  {:title => 'When Harry Met Sally', :rating => 'R', :release_date => '21-Jul-1989', :director => 'Stanley Kubrick'},
      	  {:title => 'The Help', :rating => 'PG-13', :release_date => '10-Aug-2011', :director => 'Guy Ritchie'},
      	  ...
      	  {:title => 'Chicken Run', :rating => 'G', :release_date => '21-Jun-2000', :director => 'Jean-Pierre Jeunet'},
  	 ]
